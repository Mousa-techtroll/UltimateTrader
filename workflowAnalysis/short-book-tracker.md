...
- [~] v1 MEASURED-STARVED (3 fills/7.5y; baseline isolation perfect — sleeve validated 3rd time; starvation = single-bar entry conjunction, 10,908 eligible bars ignored). v2 arm→trigger redesign registered + in build. Original design note:
