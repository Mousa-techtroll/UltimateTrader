...
**Snapshot (34 items, updated 2026-07-11):** **7 resolved + short-side program executed** (SF-1 RR-gate symmetry ADOPTED — 4th adoption, correctness class: **NEW BINDING BASELINE $23,856.89 / EqDD 13.14% / tag baseline-23856-2026-07-11**; SF-2 pin-suppressor killed at FIT on DD; CRH4 killed at FIT; §D crash suppressor adopted 07-10; full short-side diagnosis in short-side-diagnosis.md — shorts are healthy but starved, participation is the issue) (P0.2 registry-as-practice · P4.1 · P4.2 · P5.1 done; P1.4 CEG and P2.1 quality_v2 **fully executed and measured-closed** — the honest terminal state for a research item) · **11 🟡/📐 materially advanced** · 5 with ❌ measured-killed variants baked in · 12 ⬜ not started. Sub-item checkboxes mark completed work inside partial items. **Strategic consequence: exit-geometry and quality-reallocation paths are measured out; entry breadth is the remaining open path to the net target.**
