...
input bool   InpUseRealRSIScoring = true;    // FILT-04: feed a REAL closed-bar RSI to entry scoring (ON - no hardcoded RSI in decisions; immaterial vs frozen baseline)
